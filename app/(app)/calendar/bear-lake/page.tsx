  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-lg font-medium text-white mb-2">No bookings for Bear Lake</h2>
        <p className="text-slate-400 text-sm max-w-sm mb-6">
          Import your Bear Lake booking data from Airbnb or Vrbo to view the calendar and occupancy.
        </p>
        <Link
          href="/import"
